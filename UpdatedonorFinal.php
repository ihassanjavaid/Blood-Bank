...
if($conn->connect_error){
    ...
    $contactIDquery = "select ContactID from contact natural join donor where CNIC = '$CNIC' ";
...
$query3 = " update donor set historyDescrption = '$hist',
password = '$pass', GroupID = '$grpID'  where CNIC = '$CNIC' ";

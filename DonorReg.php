...
if($conn->connect_error){
    ...
    $donorIDquery = "select max(donorID) as nextIDdonor from donor";
    $donorIDresult = mysqli_query($conn, $donorIDquery);
    $resDonor = mysqli_fetch_assoc($donorIDresult);
    $donorID = $resDonor['nextIDdonor'];
    $donorID += 1;
...
$query3 = "INSERT INTO bb.donor VALUES
('$donorID', '$hist', '$CNIC', '$brID', '$pass', '$grpID' )";
